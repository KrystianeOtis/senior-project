...
def create_df(frame):
    ...
    for idx in range(5, 11):
        if keypoints_with_scores[0, 0, idx, 2] > 0.11:
    ...
    dict = {'x_left_wrist': x_left_wrist, 'y_left_wrist': y_left_wrist,
          ...
          'x_right_wrist' : x_right_wrist, 'y_right_wrist' : y_right_wrist,
...
d = pd.DataFrame(0, index=np.arange(10), columns=column_names)
